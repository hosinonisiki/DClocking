...
package mypak is
    ...
    constant module_count   : integer := 7; -- Number of modules connected to the bus.
    ...
    constant BUS_PDHS_ADDR     : std_logic_vector(mbus_w - 1 downto 0) := std_logic_vector(to_unsigned(7, mbus_w)); -- Address of the PDH state machine module. (NEW)
