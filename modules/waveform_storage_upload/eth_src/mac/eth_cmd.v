...
module eth_cmd
       ...
       (
         ...
         output reg [31:0]         ch_sel,//通道选择，未使用
         output reg [31:0]         sample_num,//采样长度
         output reg [7:0]          header,//命令头
         input                     cmd_reply_ack,//命令应答响应
         output reg                cmd_reply_req,      //cmd reply request
         output     [15:0]         cmd_send_len,       //cmd reply length
         input                     ad_data_ack,//ADC数据应答
