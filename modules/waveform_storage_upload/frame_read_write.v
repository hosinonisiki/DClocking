...
(
	...
	output wire [BUSRT_BITS - 1:0]   rd_burst_len,               // to external memory controller,data length of the burst read request, not bytes
...
//	input  wire [1:0]                read_addr_index,            // select valid base address from read_addr_0 read_addr_1 read_addr_2 read_addr_3
	...
	output wire [BUSRT_BITS - 1:0]   wr_burst_len,               // to external memory controller,data length of the burst write request, not bytes
...
//	input  wire [1:0]                write_addr_index,           // select valid base address from write_addr_0 write_addr_1 write_addr_2 write_addr_3
	...
	input  wire                      write_en,                   // data write module write request for one data
	input  wire [WRITE_DATA_BITS - 1:0]write_data,                  // write data
	output wire [15:0]                read_usedw
    );
