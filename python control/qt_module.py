from PySide6.QtWidgets import (
    ...
    QGraphicsItem, QDialog, QFormLayout, QLineEdit, QCheckBox, QPushButton,
...
# Compatibility exports for callers that historically imported these names
# from qt_module. New code should import them from their focused modules.
from qt_quantity_edit import QuantityLineEdit
from qt_pid_tuning import (
    PIDManualTuningPanel, PIDParamCanvas, PIDResponseWindow, PIDSliderSpec,
)
from qt_filter_designer import (
    FIRDesignModel, FIRDesignerWidget, FIRDesignerWindow, FIRResponseCanvas,
    IIRDesignModel, IIRDesignerWidget, IIRDesignerWindow, IIRResponseCanvas,
)
